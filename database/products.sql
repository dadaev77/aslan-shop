INSERT INTO `products` (`id`, `name`, `code`, `category_id`, `image`, `description`, `price`, `created_at`,
                        `updated_at`)
VALUES (1, 'iPhone X 64GB', 'iphone_x_64', 1, NULL, 'Отличный продвинутый телефон с памятью на 64 gb', 71990, NULL,
        NULL),
       (2, 'iPhone X 256GB', 'iphone_x_256', 1, NULL, 'Отличный продвинутый телефон с памятью на 256 gb', 89990, NULL,
        NULL),
       ...
       (7, 'Камера Panasonic HC-V770', 'panasonic_hc-v770', 2, NULL,
       ...
       (11, 'Мясорубка Bosch', 'bosch', 3, NULL,
        'Любите домашние котлеты? Вам определенно стоит посмотреть на эту мясорубку!', 9200, NULL, NULL);
