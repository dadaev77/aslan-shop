    ...
    <div class="starter-template">
        ...
        <div class="row">
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="/img/x.jpg" alt="iPhone X 64GB">
                    <div class="caption">
                        <h3>iPhone X 64GB</h3>
                        <p>41990 руб.</p>
                        <p>
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="/img/n3.jpg" alt="AirPods 3">
                    <div class="caption">
                        <h3>AirPods 3</h3>
                        <p>19500 руб.</p>
                        <p>
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="/img/beats.jpg" alt="Наушники Beats Audio">
                    <div class="caption">
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="/img/go.png" alt="Камера GoPro">
                    <div class="caption">
                        <h3>Камера GoPro</h3>
                        <p>11000 руб.</p>
                        <p>
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="/img/pan.jpg" alt="Камера Panasonic HC-V770">
                    <div class="caption">
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="img/kof.jpg" alt="Кофемашина DeLongi">
                    <div class="caption">
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="/img/hol.jpg" alt="Холодильник Haier">
                    <div class="caption">
